/**
 * Multi-provider embedding abstraction for the CLI.
...
export class GeminiProvider implements EmbeddingProvider {
  ...
  constructor(private apiKey: string) {
    if (!apiKey) throw new Error("Gemini API key required. Run 'openbrain setup' to configure.");
  }
...
export class OpenAIProvider implements EmbeddingProvider {
  ...
  constructor(private apiKey: string) {
    if (!apiKey) throw new Error("OpenAI API key required. Run 'openbrain setup' to configure.");
  }
